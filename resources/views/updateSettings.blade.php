    ...
    <div class="container_fluid mt-2 px-3">
        <table class="webforms sttbl mt-0">
            ...
            <tr>
                ...
                <td width="90%">
                    <input type="text" value="{{ @$settings->instagram }}" name="instagram" placeholder="Instagram Link">
            ...
            <tr>
                ...
                <td width="90%">
                    <input type="text" value="{{ @$settings->linkedin }}" name="linkedin" placeholder="Linkedin Link">
            ...
            <tr>
                ...
                <td width="90%">
                    <input type="email" value="{{ @$settings->email }}" name="email" placeholder="Admin email address">
            ...
            <tr>
                <td></td>
                <td>
                    <a href="javascript:;" onclick="updateSettings()" id="saveBtn" class="btn btn-success light-font">Update Settings</a>
                </td>
            </tr>
        </table>
...
<script>
    function updateSettings() 
    {
        ...
        {
            flag = 0;
            $("#instagramError").html('<span class="errorMessage" style="color:red;">Please Enter Instagram Link</span>');
        }
        ...
        {
            flag = 0;
            $("#emailError").html('<span class="errorMessage" style="color:red;">Please Enter Admin email address</span>');
        }
        // Email validation
