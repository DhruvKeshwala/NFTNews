...
<section class="hero-wrap hero-wrap-2">
    ...
    <div class="container news-banner mb-3"><a href="#" class="text-dark"><img src="{{ URL::asset('uploads/' . @$banners->image)}}" width="100%" height="auto" @if($banners->banner_image_alt != null || $banners->banner_image_alt != '') alt="{{@$banners->banner_image_alt}}" @else alt="Top Banner Image" @endif ></a></div>
    @endif
      ...
      <form action="{{ route('user.filter_crypto') }}" id="crypto_form" method="GET">
        ...
        <div class="row mt-2">
          ...
          <div class="col-md-4 d-flex">
            ...
            <a onclick="filterForCrypto('all')" id="allData" class="page-link py-3 {{ @$filterValue == 'all' || @$filterValue == '' ? 'active' : '' }}">ALL</a> 
            <a onclick="filterForCrypto('thisWeek')" class="py-3 page-link px-4 mx-2 {{ @$filterValue == 'thisWeek' ? 'active' : '' }}">THIS WEEK</a> 
            <a onclick="filterForCrypto('thisMonth')" class="py-3 page-link px-4 {{ @$filterValue == 'thisMonth' ? 'active' : '' }}">THIS MONTH</a>
          </div>
