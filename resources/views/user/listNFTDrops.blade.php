            ...
            <div class="row my-2">
                ...
                <div class="col-md-3 px-0">
                        <div class="form-group d-flex searchform border mb-0 mx-0 bg-white">
                            <input type="text" name="nft_search" value="{{@$nftsearch}}" class="form-control text-center" placeholder="SEARCH NFT Drops">
        ...
        <div class="row d-flex">
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry rounded shadow align-self-stretch">
                    <a href="nft-details.html" class="block-30 rounded"
                    ...
                    <div class="text px-4 mt-3 text-center">
                        ...
                        <p>Welcome to the Voxel Crazy Head project! Voxel Crazy Head is a collection of 10 000 NFT
                            unique heads on</p>
                        <div class="row pb-4">
                            ...
                            <div class="col-md-6 pr-0 text-left">
                                <span class="text-dark"><strong>Blockchain</strong> <span class="text-black-50">|</span>
                                    {{@$dropManagement->blockChain}}</span><br>
                                <span class="text-dark"><strong>Supply</strong> <span class="text-black-50">|</span>
                                    {{@$dropManagement->priceOfSale}}</span><br>
                                <span class="text-dark"><strong>Price</strong> <span class="text-black-50">|</span> 0.05
                                    USDT</span>
                            </div>
